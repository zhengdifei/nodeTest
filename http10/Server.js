 ...
 * 
 *实现业务处理的Engine功能
 *连接mysql数据量，DAO层封装，拦截器实现
 *insert:http://localhost:8080/common.action?command=T_BASE_FIELD.insert&ZDMC=ZDFTEST&ZDLX=int
 *update:http://localhost:8080/common.action?command=T_BASE_FIELD.update&ZDID=572&ZDMC=fei
 *delete:http://localhost:8080/common.action?command=T_BASE_FIELD.delete&ZDID=573
 *object:http://localhost:8080/common.action?command=T_BASE_FIELD.selectById&ZDID=572&ZDMC=fei
